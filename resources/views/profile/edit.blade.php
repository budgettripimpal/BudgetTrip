            ...
            <div class="flex items-center justify-between h-full">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="{{ route('dashboard') }}"
                        class="text-gray-600 hover:text-[#2CB38B] font-bold transition">Home</a>
                </div>
                <div class="flex items-center space-x-4 relative group">
                    ...
                    <div
                        class="absolute top-10 right-0 w-48 bg-white rounded-xl shadow-xl py-2 hidden group-hover:block border border-gray-100 animate-fade-in-down z-50">
            ...
            @if (session('status') === 'profile-updated' || session('status') === 'password-updated')
                <div
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Perubahan telah disimpan.</p>
                    </div>
                </div>
            @endif
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden sticky top-28">
                        <div class="p-8 text-center border-b border-gray-200 bg-gradient-to-b from-gray-50 to-white">
                            <div
                                ...
                                <span
                                    class="text-5xl font-bold text-white uppercase">{{ substr(Auth::user()->name, 0, 1) }}</span>
                            </div>
                        ...
                        <div class="p-4 space-y-1">
                            <a href="{{ route('profile.show') }}"
                                ...
                                <svg class="w-5 h-5 text-gray-400 group-hover:text-[#2CB38B]" fill="currentColor"
                                    viewBox="0 0 24 24">
                                    <path
                ...
                <div class="flex-1 space-y-8">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                        <div class="flex items-center mb-6 pb-4 border-b border-gray-100">
                            <div class="bg-blue-50 p-2 rounded-lg mr-4 text-blue-600"><svg class="w-6 h-6"
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Perbarui detail akun dan email Anda.</p>
                            </div>
                        </div>
                        ...
                        <form method="post" action="{{ route('profile.update') }}" class="space-y-6" novalidate>
                            ...
                            <div>
                                <label for="phoneNumber" class="block text-sm font-bold text-gray-700 mb-2">Nomor
                                    Telepon</label>
                            ...
                            <button type="submit"
                                class="px-6 py-3 bg-[#2CB38B] hover:bg-[#249d78] text-white font-bold rounded-xl shadow-lg transition transform active:scale-95">Simpan
                                Perubahan</button>
                        </form>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                        <div class="flex items-center mb-6 pb-4 border-b border-gray-100">
                            <div class="bg-yellow-50 p-2 rounded-lg mr-4 text-yellow-600"><svg class="w-6 h-6"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Pastikan akun Anda aman.</p>
                            </div>
                        </div>
                        ...
                        <form method="post" action="{{ route('password.update') }}" class="space-y-6" novalidate>
                            @csrf @method('put')
                            <div>
                                <label for="current_password" class="block text-sm font-bold text-gray-700 mb-2">Kata
                            ...
                            <div>
                                <label for="password" class="block text-sm font-bold text-gray-700 mb-2">Kata Sandi
                                    Baru</label>
                            ...
                            <div>
                                <label for="password_confirmation"
                                    class="block text-sm font-bold text-gray-700 mb-2">Konfirmasi Kata Sandi</label>
                                <input type="password" id="password_confirmation" name="password_confirmation"
                                    class="w-full px-4 py-3 rounded-xl border-gray-200 focus:border-[#2CB38B] focus:ring-2 focus:ring-[#2CB38B]/20 bg-gray-50 text-gray-800 outline-none transition">
                                <x-input-error :messages="$errors->updatePassword->get('password_confirmation')" class="mt-2" />
                            </div>
                            <button type="submit"
                                class="px-6 py-3 bg-gray-800 hover:bg-gray-900 text-white font-bold rounded-xl shadow-lg transition transform active:scale-95">Update
                                Password</button>
                        </form>
                    </div>
                    ...
                    <div class="bg-red-50 rounded-2xl shadow-inner p-8 border border-red-100">
                        <div class="flex items-center mb-4">
                            <div class="bg-red-100 p-2 rounded-lg mr-4 text-red-600"><svg class="w-6 h-6"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div>
                                ...
                                <p class="text-sm text-red-500">Tindakan ini permanen.</p>
                            </div>
                        </div>
                        <p class="text-sm text-gray-600 mb-6">Setelah dihapus, semua data Anda akan hilang selamanya.
                        </p>
                        ...
                        <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
                            <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
                                @csrf @method('delete')
                                <h2 class="text-lg font-medium text-gray-900">{{ __('Yakin ingin menghapus akun?') }}
                                </h2>
                                <p class="mt-1 text-sm text-gray-600">
                                    {{ __('Masukkan password Anda untuk konfirmasi penghapusan permanen.') }}</p>
                                <div class="mt-6">
