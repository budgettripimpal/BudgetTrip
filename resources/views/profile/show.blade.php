                ...
                <div class="w-full lg:w-80 flex-shrink-0">
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden sticky top-28">
                        ...
                        <div class="p-4 space-y-1">
                            <a href="{{ route('profile.show') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl bg-[#2CB38B]/10 text-gray-900 font-bold border-l-4 border-[#2CB38B] transition">
                                <svg class="w-5 h-5 text-[#2CB38B]" fill="currentColor" viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>
                                <span>Profile</span>
                            </a>
                            ...
                            <a href="{{ route('profile.edit') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-600 hover:bg-gray-50 hover:text-[#2CB38B] transition font-medium group">
                                <svg class="w-5 h-5 text-gray-400 group-hover:text-[#2CB38B]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/></svg>
                ...
                <div class="flex-1">
                    <div class="bg-white rounded-2xl shadow-lg p-8 md:p-10 border border-gray-100 h-full">
                        ...
                        <div class="flex items-center justify-between mb-10 border-b border-gray-100 pb-6">
                            ...
                            <a href="{{ route('profile.edit') }}" class="hidden md:flex items-center gap-2 px-6 py-3 bg-[#2CB38B] text-white rounded-xl font-semibold hover:bg-[#249d78] transition shadow-md shadow-green-200">
                        ...
                        <div class="space-y-8 max-w-2xl">
                            ...
                            <div class="group">
                                <label class="block text-gray-400 text-xs font-bold uppercase tracking-wider mb-2">Nama Lengkap</label>
                                <div class="flex items-center justify-between border-b border-gray-200 pb-2 group-hover:border-[#2CB38B] transition">
                            ...
                            <div class="group">
                                <label class="block text-gray-400 text-xs font-bold uppercase tracking-wider mb-2">Nomor Telepon</label>
                                <div class="flex items-center justify-between border-b border-gray-200 pb-2 group-hover:border-[#2CB38B] transition">
                            ...
                            <div class="group">
                                <label class="block text-gray-400 text-xs font-bold uppercase tracking-wider mb-2">Alamat Email</label>
                                <div class="flex items-center justify-between border-b border-gray-200 pb-2 group-hover:border-[#2CB38B] transition">
                            ...
                            <div class="md:hidden pt-6">
                                <a href="{{ route('profile.edit') }}" class="block w-full px-6 py-3 bg-[#2CB38B] hover:bg-[#249d78] text-white font-bold rounded-xl shadow-lg text-center">
                                    Ubah Profil
                                </a>
                            </div>
