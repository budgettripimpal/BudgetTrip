        ...
        <div class="max-w-7xl mx-auto px-8 py-8">
            <div class="mb-8">
                ...
                <div class="ml-14 mt-3">
                    <p class="text-gray-500 mb-4 text-lg">Total Budget: <span class="font-bold text-[#2CB38B]">Rp
                            {{ number_format($plan->amount, 0, ',', '.') }}</span></p>

                    <div class="flex flex-wrap gap-3">
                        <div
                            class="flex items-center gap-2 bg-white px-4 py-2 rounded-xl border border-gray-200 shadow-sm">
                        ...
                        <div
                            ...
                            <span class="text-sm font-bold text-gray-700">
                                {{ \Carbon\Carbon::parse($plan->startDate)->format('d M Y') }}
                                <span class="text-gray-400 mx-1">-</span>
                                {{ \Carbon\Carbon::parse($plan->endDate)->format('d M Y') }}
                            </span>
                        </div>
                    </div>
                </div>
