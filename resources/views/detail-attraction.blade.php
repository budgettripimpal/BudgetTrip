                ...
                <div>
                    <div class="bg-white rounded-3xl shadow-lg p-8">
                        ...
                        <div class="flex items-center gap-2 mb-6">
                            <span class="bg-blue-100 text-blue-600 px-3 py-1 rounded-full text-xs font-bold">{{ $attraction->category }}</span>
                            <span class="text-yellow-500 font-bold">★ {{ $attraction->rating }}</span>
                        </div>
                        <p class="text-gray-600 leading-relaxed mb-8">{{ $attraction->description ?? 'Nikmati keindahan wisata ini.' }}</p>
