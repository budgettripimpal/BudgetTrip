...
<head>
    ...
    <title>Detail Wisata - Budget Trip</title>
                ...
                <div class="space-y-6">
                    <div class="bg-white rounded-3xl shadow-lg overflow-hidden aspect-video">
                        <img src="{{ $attraction->images[0] ?? 'https://placehold.co/600x400?text=Wisata' }}"
                            class="w-full h-full object-cover" alt="{{ $attraction->attractionName ?? 'Wisata' }}">
                    </div>
                    ...
                    @if (isset($attraction->latitude) && isset($attraction->longitude))
                        <div class="bg-white rounded-3xl shadow-lg p-6 border border-gray-100">
                            ...
                            <p class="text-xs text-gray-500 mt-3 text-center">
                                Koordinat: {{ $attraction->latitude }}, {{ $attraction->longitude }}
                            </p>
                        </div>
                    @endif
                </div>
