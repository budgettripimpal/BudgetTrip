            ...
            <div class="grid lg:grid-cols-2 gap-8">
                <div>
                    <div class="bg-white rounded-3xl shadow-lg overflow-hidden mb-4 aspect-video"><img
                            src="{{ $accommodation->images[0] ?? 'https://placehold.co/600x400?text=Hotel' }}"
                ...
                <div>
                    <div class="bg-white rounded-3xl shadow-lg p-8">
                        ...
                        <div class="text-yellow-400 text-lg mb-4">{{ str_repeat('★', floor($accommodation->rating)) }}
                            <span class="text-gray-400 text-sm">({{ $accommodation->rating }})</span></div>
                        <p class="text-gray-600 leading-relaxed mb-8">
                            {{ $accommodation->description ?? 'Deskripsi hotel tidak tersedia.' }}</p>
                        ...
                        <div class="space-y-4 mb-8 text-sm">
                            <div class="flex justify-between py-3 border-b border-gray-200"><span
                                    class="text-gray-600 font-medium">Tipe</span><span
                                    class="text-gray-800 font-semibold">{{ $accommodation->type }}</span></div>
