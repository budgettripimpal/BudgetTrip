                ...
                <div class="flex items-center justify-between max-w-6xl mx-auto">
                    ...
                    <div class="flex items-center flex-1">
                        <div class="flex flex-col items-center relative z-10">
                            ...
                            <p class="text-xs font-bold text-[#2CB38B] text-center">Pilih<br>Wisata</p>
                        </div>
                    ...
                    <div class="w-full lg:w-80 flex-shrink-0">
                        <div class="bg-white rounded-2xl shadow-lg p-6 sticky top-44 border border-gray-100">
                                ...
                                <div class="space-y-2">
                                    @foreach (['Alam', 'Sejarah & Budaya', 'Kuliner', 'Belanja', 'Hiburan', 'Landmark'] as $cat)
                                        <label class="flex items-center space-x-3 cursor-pointer group">
                                            ...
                                            <span
                                                class="text-gray-600 group-hover:text-[#2CB38B]">{{ $cat }}</span>
                                        </label>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-2">
                                    <label class="flex items-center space-x-3 cursor-pointer group">
                                        <input type="checkbox" name="prices[]" value="free"
                                            class="w-5 h-5 text-[#2CB38B] rounded border-gray-300 focus:ring-[#2CB38B]"
                                    ...
                                    <label class="flex items-center space-x-3 cursor-pointer group">
                                        <input type="checkbox" name="prices[]" value="under_50"
                                            class="w-5 h-5 text-[#2CB38B] rounded border-gray-300 focus:ring-[#2CB38B]"
                                            {{ in_array('under_50', request('prices', [])) ? 'checked' : '' }}
                                            onchange="this.form.submit()">
                                        <span class="text-gray-600 group-hover:text-[#2CB38B]">&lt; Rp 50.000</span>
                                    </label>
                                    <label class="flex items-center space-x-3 cursor-pointer group">
                                        <input type="checkbox" name="prices[]" value="over_100"
                                            class="w-5 h-5 text-[#2CB38B] rounded border-gray-300 focus:ring-[#2CB38B]"
                                            {{ in_array('over_100', request('prices', [])) ? 'checked' : '' }}
                                            onchange="this.form.submit()">
                                        ...
                                        <div class="w-full md:w-2/3 flex flex-col justify-between">
                                            <div>
                                                <div class="flex justify-between items-start">
                                                    ...
                                                    <span
                                                        class="bg-green-50 text-[#2CB38B] text-xs px-3 py-1 rounded-full font-bold">{{ $spot->category }}</span>
                                                </div>
                                                ...
                                                <p class="text-xs text-gray-400 mt-2">
                                                    {{ number_format($spot->reviewCount) }} ulasan</p>
                                            </div>
                                                ...
                                                <div>
                                                    ...
                                                    @else
                                                        <p class="text-2xl font-bold text-[#2CB38B]">Rp
                                                            {{ number_format($spot->estimatedCost, 0, ',', '.') }}</p>
                                                        <p class="text-xs text-gray-500">/ orang</p>
                                                    @endif
                                                </div>
                                                <a href="{{ route('attraction.show', ['travelPlan' => $plan->planID, 'id' => $spot->attractionID]) }}"
