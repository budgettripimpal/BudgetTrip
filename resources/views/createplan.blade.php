<x-app-layout>
    ...
    <style>
        ...
        .ring-primary:focus { --tw-ring-color: #2CB38B; }
                ...
                <div class="flex items-center justify-between max-w-6xl mx-auto">
                    ...
                    <div class="flex items-center flex-1">
                        <div class="flex flex-col items-center relative z-10">
                            <div class="w-16 h-16 bg-[#2CB38B] rounded-full flex items-center justify-center mb-2 shadow-lg ring-4 ring-green-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            @if (session('success'))
                <div class="mb-6 bg-green-50 border-l-4 border-[#2CB38B] p-4 rounded-r-md shadow-sm flex items-start animate-fade-in-down">
                    <svg class="h-5 w-5 text-[#2CB38B] mt-0.5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-[2.5rem] flex flex-col lg:flex-row border border-gray-100 relative">
                ...
                <div class="hidden lg:block lg:w-1/3 relative bg-gray-100">
                    <img src="https://images.unsplash.com/photo-1530789253388-582c481c54b0?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" class="absolute inset-0 w-full h-full object-cover">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent"></div>
                    <div class="absolute bottom-16 left-8 right-8 text-white">
                        <p class="text-2xl font-serif italic leading-relaxed drop-shadow-lg">"Investasi terbaik adalah memasukkan uang ke dalam kenangan."</p>
                    </div>
                </div>
            </div>
        </div>
