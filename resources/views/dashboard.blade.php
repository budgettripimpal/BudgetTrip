<x-app-layout>
    ...
    <section class="bg-[#FFFBF0] pt-32 pb-0 min-h-[85vh] flex items-center overflow-hidden relative">
        ...
        <div
            class="absolute top-[-10%] right-[-5%] w-[600px] h-[600px] bg-[#FFDF67] rounded-full mix-blend-multiply filter blur-[100px] opacity-100 pointer-events-none">
        </div>
        <div
            class="absolute bottom-[-20%] left-[-5%] w-[600px] h-[600px] bg-[#FFDF67] rounded-full mix-blend-multiply filter blur-[100px] opacity-100 pointer-events-none">
        </div>
        ...
        <div class="container mx-auto px-6 max-w-7xl relative z-10 mb-16">
            <div class="flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
                ...
                <div class="w-full lg:w-5/12 space-y-6 text-center lg:text-left z-20">
                    <h1
                        class="text-5xl md:text-6xl lg:text-7xl font-black text-[#181E4B] leading-[1.1] tracking-tighter">
                        Travel smart. <br> Save more. <br> Experience <br> better.
                    </h1>

                    <p class="text-[#5E6282] font-medium text-base lg:text-lg leading-relaxed max-w-lg mx-auto lg:mx-0">
                        Setiap perjalanan punya cerita, dan Budget Trip memastikan ceritamu dimulai dengan perencanaan
                        yang cerdas. Dari destinasi impian hingga rincian biaya, semuanya bisa kamu atur dalam satu
                        aplikasi hemat perjalanan ini.✨
                    </p>

                    <div class="flex flex-col items-center lg:items-start space-y-5 pt-4">
                        <a href="{{ route('travel-plan.create') }}"
                            class="px-10 py-4 bg-[#2CB38B] text-white font-bold text-lg rounded-full shadow-lg shadow-green-200 hover:bg-[#249372] transition transform hover:-translate-y-1 w-full md:w-auto min-w-[240px] text-center">
                            Buat Rencana Sekarang!
                        </a>

                        <div class="space-y-2 w-full md:w-auto">
                            <p class="text-gray-400 font-semibold text-sm pl-2 hidden lg:block">Sudah Memiliki Rencana?
                            </p>
                            <p class="text-gray-400 font-semibold text-sm lg:hidden">Sudah Memiliki Rencana?</p>

                            <a href="{{ route('travel-plan.index') }}"
                                class="block px-10 py-4 bg-[#2CB38B] text-white font-bold text-lg rounded-full shadow-lg shadow-green-200 hover:bg-[#249372] transition transform hover:-translate-y-1 w-full md:w-auto min-w-[240px] text-center">
                ...
                <div class="w-full lg:w-7/12 relative flex justify-center lg:justify-end">
                    <img src="{{ asset('images/dashboard-hero.png') }}" alt="Travel Couple"
        ...
        <div
            class="absolute bottom-0 left-0 w-full h-22 md:h-28 bg-gradient-to-b from-transparent to-white z-10 pointer-events-none">
        </div>
    </section>
        ...
        <div class="container mx-auto px-6">
            <div class="grid md:grid-cols-2 gap-16 items-center">
                ...
                <div class="flex justify-center">
                    <div
                        class="bg-white rounded-[60px] shadow-2xl p-6 border border-gray-50 transform hover:scale-105 transition duration-300 flex items-center justify-center aspect-square w-full max-w-lg relative overflow-hidden">
                        <div class="absolute top-0 right-0 w-40 h-40 bg-green-50 rounded-full blur-3xl opacity-60">
                        </div>
                        <div class="absolute bottom-0 left-0 w-40 h-40 bg-blue-50 rounded-full blur-3xl opacity-60">
                        </div>

                        <div
                            class="relative z-10 w-[400px] h-[400px] bg-white border-[10px] border-green-50/30 rounded-full flex items-center justify-center shadow-[inset_0_4px_20px_rgba(0,0,0,0.03)] p-4">
                            <img src="{{ asset('images/budgettrip-logo.png') }}" alt="BudgetTrip Logo"
                ...
                <div>
                    ...
                    <p class="text-gray-600 leading-relaxed mb-8 text-justify text-lg">
                        Kami percaya bahwa setiap orang berhak merasakan pengalaman perjalanan tanpa harus khawatir soal
                        biaya. Karena itu, Budget Trip hadir sebagai teman perencanaan perjalananmu—memberi rekomendasi
                        hemat, tips liburan, dan panduan destinasi yang dinamis khusus sesuai budget. Dengan Budget
                        Trip, kamu bisa fokus menikmati momen. Biarkan bagian rumitnya kami yang urus.
                    </p>
                        ...
                        <div class="grid grid-cols-4 gap-4">
                            @foreach (['Dani', 'Fajril', 'Haris', 'Damar'] as $name)
                                <div class="text-center group cursor-pointer">
                                    <div
                                        class="w-16 h-16 bg-[#2CB38B] rounded-full mx-auto mb-3 flex items-center justify-center shadow-md group-hover:scale-110 transition text-white font-bold text-xl border-4 border-white">
                                        {{ substr($name, 0, 1) }}
                                    </div>
                                    <p class="text-sm text-gray-700 font-bold group-hover:text-[#2CB38B] transition">
                                        {{ $name }}</p>
                                </div>
                            @endforeach
                        </div>
    ...
    <section id="tutorial" class="py-20 bg-white relative overflow-hidden scroll-mt-32">
        <div
            class="absolute top-0 left-0 w-full h-40 bg-gradient-to-b from-white via-white/80 to-transparent z-10 pointer-events-none">
        </div>
        <div
            class="absolute bottom-0 left-0 w-full h-40 bg-gradient-to-t from-white via-white/80 to-transparent z-10 pointer-events-none">
        </div>

        <div
            class="absolute top-[-10%] right-[-5%] w-[600px] h-[600px] bg-[#2CB38B] rounded-full mix-blend-multiply filter blur-[100px] opacity-40 pointer-events-none animate-pulse">
        </div>
        <div
            class="absolute top-0 left-[-10%] w-[600px] h-[600px] bg-[#2CB38B] rounded-full mix-blend-multiply filter blur-3xl opacity-20 -z-10 animate-blob">
        </div>
        <div
            class="absolute bottom-0 right-[-10%] w-[600px] h-[600px] bg-[#2CB38B] rounded-full mix-blend-multiply filter blur-3xl opacity-20 -z-10 animate-blob animation-delay-2000">
        </div>

        <div class="max-w-7xl mx-auto px-6 relative z-10">
            <div class="text-center mb-16 fade-in-up delay-100">
                <h2 class="text-4xl md:text-5xl font-extrabold text-[#181E4B] mb-3 tracking-tight">Make Your Own Trip
                </h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
                ...
                <div
                    class="bg-white rounded-[40px] p-8 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.08)] border border-gray-100 hover:shadow-[0_20px_50px_-10px_rgba(44,179,139,0.2)] hover:border-[#2CB38B]/30 hover:-translate-y-2 transition-all duration-300 flex flex-col items-center text-center group h-full relative overflow-hidden">
                    <div
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed">Input jumlah uang yang ingin Anda habiskan.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed">Pilih travel, bus, atau kereta terbaik.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed">Cari penginapan nyaman sesuai budget.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed">Tambahkan destinasi seru ke itinerary.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed">Simpan dan mulai perjalananmu!</p>
                </div>
    ...
    <section id="testimonials" class="py-20 bg-white relative scroll-mt-32">
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
                <div
                    class="bg-gray-50 rounded-[40px] p-10 border border-gray-100 shadow-lg relative hover:-translate-y-2 transition-transform duration-300">
                    ...
                    <p class="text-gray-600 leading-relaxed italic mb-8 relative z-10 pt-4">
                        "Budget Trip benar-benar ngebantu aku yang sering bingung soal biaya liburan. Fiturnya simple,
                        estimasinya akurat, dan rekomendasinya pas banget sama budget-ku!"
                    </p>
                    <div class="flex items-center gap-4">
                        <div
                            class="w-12 h-12 bg-gray-300 rounded-full overflow-hidden border-2 border-white shadow-sm">
                ...
                <div
                    class="bg-white rounded-[40px] p-10 border border-gray-100 shadow-xl relative transform md:-translate-y-4 hover:-translate-y-6 transition-transform duration-300 z-10">
                    <div class="absolute top-6 left-8 text-6xl text-[#2CB38B] opacity-20 font-serif">“</div>
                    <p class="text-gray-600 leading-relaxed italic mb-8 relative z-10 pt-4">
                        "Aplikasi terbaik untuk backpacker! Saya bisa keliling Jogja dan Bali dengan budget minim tapi
                        tetap dapat penginapan yang nyaman. Sangat direkomendasikan!"
                    </p>
                    <div class="flex items-center gap-4">
                        <div
                            class="w-12 h-12 bg-gray-300 rounded-full overflow-hidden border-2 border-white shadow-sm">
                ...
                <div
                    ...
                    <div class="absolute top-6 left-8 text-6xl text-[#2CB38B] opacity-20 font-serif">“</div>
                    <p class="text-gray-600 leading-relaxed italic mb-8 relative z-10 pt-4">
                        "Fitur penyusunan itinerary-nya juara. Saya tidak perlu repot riset satu-satu, Budget Trip sudah
                        menyusunkan rute wisata yang efisien dan hemat waktu."
                    </p>
                    <div class="flex items-center gap-4">
                        <div
                            class="w-12 h-12 bg-gray-300 rounded-full overflow-hidden border-2 border-white shadow-sm">
            ...
            <div class="grid md:grid-cols-4 gap-12 mb-12">
                <div class="col-span-1 md:col-span-1">
                    <div class="flex items-center space-x-2 mb-6">
                        ...
                        <span class="text-2xl font-bold"><span class="text-gray-800">BUDGET</span><span
                                class="text-[#2CB38B]">TRIP</span></span>
                    </div>
                    <p class="text-gray-500 text-sm leading-relaxed mb-6">
                        Budget Trip adalah teman perencanaan perjalanan hemat Anda. Kami memberikan rekomendasi terbaik
                        sesuai anggaran.
                    </p>
