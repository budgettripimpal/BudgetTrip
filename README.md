...
Aplikasi ini dibangun menggunakan Framework **Laravel** dan mengintegrasikan **Midtrans Payment Gateway**.
...
- **Node.js & NPM**: Untuk manajemen aset frontend (Tailwind CSS/Vite).
- **MySQL / MariaDB**: Untuk database.
- **Web Browser**: Google Chrome / Microsoft Edge (Disarankan).
